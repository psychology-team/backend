...
public class ApiKey {
    ...
    public static final String ADMIN_CLIENTS_ALL = "/clients/all"; // Endpoint to get/change all clients
    public static final String ADMIN_CLIENT_ID = "/client/{id}"; // Endpoint to get/change client by ID
    ...
    public static final String DIAGNOSTIC_GET_ALL = "/get-all"; // Endpoint to get/change all diagnostics
    public static final String DIAGNOSTIC_ID = "/{id}"; // Endpoint to get/change diagnostic by ID
    ...
    public static final String DIAGNOSTIC_QUESTION_ID = "/question/{id}"; // Endpoint to get/change diagnostic question by ID
    public static final String DIAGNOSTIC_ANSWER_ID = "/answer/{id}"; // Endpoint to get/change diagnostic answer by ID
    public static final String DIAGNOSTIC_RESULT = "/result"; // Endpoint to get/change diagnostic result
